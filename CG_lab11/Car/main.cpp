...
void Init(void)
{
	...
	t3 = SOIL_load_OGL_texture("textures/cabine.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, 0);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);

	t4 = SOIL_load_OGL_texture("textures/cargo.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, 0);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
...
void Update(void)
{
	...
	pos[0] = cam_x; pos[1] = cam_y; pos[2] = cam_z; pos[3] = 0;
	glLightfv(GL_LIGHT7, GL_POSITION, pos);
	glLightf(GL_LIGHT7, GL_SPOT_CUTOFF, 50);
	glLightfv(GL_LIGHT7, GL_SPOT_DIRECTION, cam_dir);

	float dir[] = { 0, 1, 0, 1 };
	glTranslatef(dist_x, dist_y, 0);
	glRotatef(angle, 0, 0, 1);
	pos[0] = -0.3; pos[1] = 1; pos[2] = 0.5; pos[3] = 1;
	...
	glBegin(GL_QUADS);
	glNormal3f(0, 0, 1); glTexCoord2f(0.0, 0.0); glVertex3f(-10.0, -10.0, 0.0);
	...
	glNormal3f(-1, -1, -1); glTexCoord2f(0.0, 0.0); glVertex3f(-0.5, 0.2, 1);
	glNormal3f(-1, 1, -1); glTexCoord2f(0.0, 1.0); glVertex3f(-0.5, 1, 1);
	glNormal3f(-1, 1, 1); glTexCoord2f(0.5, 1.0); glVertex3f(-0.5, 1, 1.5);
	glNormal3f(-1, -1, 1); glTexCoord2f(0.5, 0.0); glVertex3f(-0.5, 0.2, 1.5);

	glNormal3f(1, -1, 1); glTexCoord2f(0.0, 0.0); glVertex3f(0.5, 0.2, 1.5);
	glNormal3f(1, 1, 1); glTexCoord2f(0.0, 1.0); glVertex3f(0.5, 1, 1.5);
	glNormal3f(1, 1, -1); glTexCoord2f(0.5, 1.0); glVertex3f(0.5, 1, 1);
	glNormal3f(1, -1, -1); glTexCoord2f(0.5, 0.0); glVertex3f(0.5, 0.2, 1);
	...
	glNormal3f(-1, 1, -1); glTexCoord2f(0.0, 0.0); glVertex3f(-0.5, 1, 1);
	glNormal3f(1, 1, -1); glTexCoord2f(0.0, 0.5); glVertex3f(0.5, 1, 1);
	glNormal3f(1, 1, 1); glTexCoord2f(0.5, 0.5); glVertex3f(0.5, 1, 1.5);
	glNormal3f(-1, 1, 1); glTexCoord2f(0.5, 0.0); glVertex3f(-0.5, 1, 1.5);

	glNormal3f(-1, -1, -1); glTexCoord2f(0.0, 0.0); glVertex3f(-0.5, 0.2, 1);
	glNormal3f(1, -1, -1); glTexCoord2f(0.0, 0.5); glVertex3f(0.5, 0.2, 1);
	glNormal3f(1, -1, 1); glTexCoord2f(0.5, 0.5); glVertex3f(0.5, 0.2, 1.5);
	glNormal3f(-1, -1, 1); glTexCoord2f(0.5, 0.0); glVertex3f(-0.5, 0.2, 1.5);
	glEnd();
	glDisable(GL_TEXTURE_2D);
	...
	glNormal3f(-1, -1, -1); glTexCoord2f(0.0, 0.0); glVertex3f(-0.5, -1, 1);
	glNormal3f(-1, 1, -1); glTexCoord2f(0.0, 1.0); glVertex3f(-0.5, 0.2, 1);
	glNormal3f(-1, 1, 1); glTexCoord2f(0.5, 1.0); glVertex3f(-0.5, 0.2, 2);
	glNormal3f(-1, -1, 1); glTexCoord2f(0.5, 0.0); glVertex3f(-0.5, -1, 2);

	glNormal3f(1, -1, 1); glTexCoord2f(0.0, 0.0); glVertex3f(0.5, -1, 2);
	glNormal3f(1, 1, 1); glTexCoord2f(0.0, 1.0); glVertex3f(0.5, 0.2, 2);
	glNormal3f(1, 1, -1); glTexCoord2f(0.5, 1.0); glVertex3f(0.5, 0.2, 1);
	glNormal3f(1, -1, -1); glTexCoord2f(0.5, 0.0); glVertex3f(0.5, -1, 1);
	...
	glNormal3f(-1, 1, -1); glTexCoord2f(0.0, 0.0); glVertex3f(-0.5, 0.2, 1);
	glNormal3f(1, 1, -1); glTexCoord2f(0.0, 0.5); glVertex3f(0.5, 0.2, 1);
	glNormal3f(1, 1, 1); glTexCoord2f(0.5, 0.5); glVertex3f(0.5, 0.2, 2);
	glNormal3f(-1, 1, 1); glTexCoord2f(0.5, 0.0); glVertex3f(-0.5, 0.2, 2);

	glNormal3f(-1, -1, -1); glTexCoord2f(0.0, 0.0); glVertex3f(-0.5, -1, 1);
	glNormal3f(1, -1, -1); glTexCoord2f(0.0, 0.5); glVertex3f(0.5, -1, 1);
	glNormal3f(1, -1, 1); glTexCoord2f(0.5, 0.5); glVertex3f(0.5, -1, 2);
	glNormal3f(-1, -1, 1); glTexCoord2f(0.5, 0.0); glVertex3f(-0.5, -1, 2);
	glEnd();
	glDisable(GL_TEXTURE_2D);
...
void SpecialKeys(int key, int x, int y)
{
	...
	{
	case GLUT_KEY_UP:
		dist_x -= step * std::sin(angle / 180 * M_PI);
		dist_y += step * std::cos(angle / 180 * M_PI);
		break;
	case GLUT_KEY_DOWN:
		dist_x += step * std::sin(angle / 180 * M_PI);
		dist_y -= step * std::cos(angle / 180 * M_PI);
